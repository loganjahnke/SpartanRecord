...
export function PlayerCard(props: PlayerCardProps)
{
	...
	return (
        <Box className="playerCard" sx={{ backgroundColor: "transparent", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: rightAlign ? "flex-end" : noImages ? "center" : "flex-start", width: "50%", textAlign: rightAlign ? "right" : noImages ? "center" : "left" }}>

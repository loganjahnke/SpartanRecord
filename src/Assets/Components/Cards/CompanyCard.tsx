...
export function CompanyCard(props: CompanyCardProps)
{
	...
	return (
        <Box className="companyCard" sx={{ backgroundColor: "transparent", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: noImages ? "center" : "flex-start", width: "calc(100% - 80px)" }}>

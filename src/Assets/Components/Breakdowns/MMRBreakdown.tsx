	...
	return (
		<TitleCard title="MMR">
            <Box sx={{ display: "flex", flexDirection: "row", flexWrap: "wrap", alignItems: "center", justifyContent: "space-evenly", width: "100%" }}>
                <BreakdownTile title="FFA" value={mmr.ffa?.toLocaleString() ?? "N/A"} isMainStat />
                <BreakdownTile title="Last Spartan Standing" value={mmr.lastSpartanStanding?.toLocaleString() ?? "N/A"} isMainStat />
            </Box>
		</TitleCard>
	);
}
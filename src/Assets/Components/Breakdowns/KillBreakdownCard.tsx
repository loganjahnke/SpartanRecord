		...
		<TitleCard title="Kills">
			...
			<Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", flexWrap: "wrap", justifyContent: "space-evenly", width: "100%" }}>
				<BreakdownRowTile title="Melee" 
					...
					icon={<img src="https://etxvqmdrjezgtwgueiar.supabase.co/storage/v1/object/public/assets/games/halo-infinite/metadata/multiplayer/medals/269174970.png" alt="Medal" height="48px" width="48px" />} 
				...
				<BreakdownRowTile title="Headshots" 
					...
					icon={<img src="https://etxvqmdrjezgtwgueiar.supabase.co/storage/v1/object/public/assets/games/halo-infinite/metadata/multiplayer/medals/2758320809.png" alt="Medal" height="48px" width="48px" />} 
				...
				<BreakdownRowTile title="Power Weapons" 
					...
					icon={<img src="https://etxvqmdrjezgtwgueiar.supabase.co/storage/v1/object/public/assets/games/halo-infinite/metadata/multiplayer/medals/1146876011.png" alt="Medal" height="48px" width="48px" />} 
				...
				<BreakdownRowTile title="Grenades" 
					...
					icon={<img src="https://etxvqmdrjezgtwgueiar.supabase.co/storage/v1/object/public/assets/games/halo-infinite/metadata/multiplayer/medals/2648272972.png" alt="Medal" height="48px" width="48px" />} 
				...
				<BreakdownRowTile title="Fusion Coils" 
					tooltip="Kong!" 
					icon={<img src="https://etxvqmdrjezgtwgueiar.supabase.co/storage/v1/object/public/assets/games/halo-infinite/metadata/multiplayer/medals/3546244406.png" alt="Medal" height="48px" width="48px" />} 
				...
				<BreakdownRowTile title="Assassinations" 
					...
					icon={<img src="https://etxvqmdrjezgtwgueiar.supabase.co/storage/v1/object/public/assets/games/halo-infinite/metadata/multiplayer/medals/548533137.png" alt="Medal" height="48px" width="48px" />} 
				...
				<BreakdownRowTile title="Splatters" 
					tooltip="Vroom!" 
					icon={<img src="https://etxvqmdrjezgtwgueiar.supabase.co/storage/v1/object/public/assets/games/halo-infinite/metadata/multiplayer/medals/3027762381.png" alt="Medal" height="48px" width="48px" />} 
				...
				<BreakdownRowTile title="Repulsor" 
					...
					icon={<img src="https://etxvqmdrjezgtwgueiar.supabase.co/storage/v1/object/public/assets/games/halo-infinite/metadata/multiplayer/medals/1880789493.png" alt="Medal" height="48px" width="48px" />} 

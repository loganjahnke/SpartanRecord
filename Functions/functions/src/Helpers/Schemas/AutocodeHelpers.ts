...
import { AutocodeMultiplayerServiceRecord, AutocodeServiceRecordData } from "./AutocodeMultiplayerServiceRecord";
...
export class AutocodeHelpers
{
	...
	public static TrimHistoricServiceRecord(historicSR: AutocodeMultiplayerServiceRecord): FirebaseHistoricServiceRecord
	{
		return { 
			core: {
				summary: {
					kills: historicSR.data.core.summary.kills,
					deaths: historicSR.data.core.summary.deaths,
					assists: historicSR.data.core.summary.assists
				},
				damage: {
					taken: historicSR.data.core.damage.taken,
					dealt: historicSR.data.core.damage.dealt,
				},
				shots: {
					accuracy: historicSR.data.core.shots.accuracy,
				},
				kda: historicSR.data.core.kda,
				kdr: historicSR.data.core.kdr,
				scores: {
					personal: historicSR.data.core.scores.personal
				},
			},
			matches: {
				outcomes: {
					wins: historicSR.data.matches.outcomes.wins,
					draws: historicSR.data.matches.outcomes.draws,
					losses: historicSR.data.matches.outcomes.losses,
					left: historicSR.data.matches.outcomes.left,
				},
				total: historicSR.data.matches.total,
				win_rate: historicSR.data.matches.win_rate,
			}
		};
	}
	...
	{	
		...
		this.AddSummary(data, playerDetails);
		this.AddDamage(data, playerDetails);
		this.AddScore(data, playerDetails);
		this.AddShots(data, playerDetails);
		this.AddBreakdown(data, playerDetails);
		this.AddRounds(data, playerDetails);
	 ...
	 */
	private static AddSummary(key: AutocodeServiceRecordData, player: AutocodeMatchPlayer): void
	{
	 ...
	 * @param player the player details
	 */
	private static AddDamage(key: AutocodeServiceRecordData, player: AutocodeMatchPlayer): void
	{
	 ...
	 * @param player the player details
	 */
	private static AddShots(key: AutocodeServiceRecordData, player: AutocodeMatchPlayer): void
	{
	 ...
	 * @param player the player details
	 */
	private static AddRounds(key: AutocodeServiceRecordData, player: AutocodeMatchPlayer): void
	{
	 ...
	 * @param player the player details
	 */
	private static AddScore(key: AutocodeServiceRecordData, player: AutocodeMatchPlayer): void
	{
	 ...
	 * @param player the player details
	 */
	private static AddBreakdown(key: AutocodeServiceRecordData, player: AutocodeMatchPlayer): void
	{
